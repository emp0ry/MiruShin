...
APP = {
    ...
    "screenshots": [
        f"https://raw.githubusercontent.com/{DEFAULT_REPO}/{RAW_BRANCH}/docs/assets/imgs/board.png",
        f"https://raw.githubusercontent.com/{DEFAULT_REPO}/{RAW_BRANCH}/docs/assets/imgs/player.png",
    ],
